...
function About() {
  return (
    <div className='max-w-5xl mx-auto flex flex-col gap-6 items-center px-4 py-8 font-serif m-18'>
      ...
      <p className='text-center text-black-600 text-base md:text-lg max-w-3xl italic'>Hello, I am Rakshya Gharti Magar, a passionate frontend developer from Nepal. I enjoy building responsive and user friendly web applications.</p>
      <p className='text-center text-black-600 text-base md:text-lg max-w-3xl italic'>I love learning new technologies, solving problems and creating modern websites that provides great user experiences.</p>

      <div className='border border-gray-900 rounded-lg w-full max-w-4xl p-6 text-center uppercase rounded-sm  text-center' >
        <h3 className='text-green-900 font-bold p-2 text-lg'>My frontend knowledge and skills</h3>
